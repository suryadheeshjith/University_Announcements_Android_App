...
public class ann_info_fragment extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.fragment_ann_info, container, false);
...
//        t3.setAutoLinkMask(Linkify.PHONE_NUMBERS);
